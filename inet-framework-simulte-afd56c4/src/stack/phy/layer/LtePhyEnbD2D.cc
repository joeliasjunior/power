...
//        enableD2DBatteryReporting_ = par("enableD2DBatteryReporting"); // JOELIAS
}
...
/*            if (enableD2DBatteryReporting)
            {
                ...
                for (; it != ueList->end(); ++it)
                {
                    pwr = inet.power.storage.SimpleEnergyStorage.energyStorage.initialCapacity;
                }
